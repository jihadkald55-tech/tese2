...
import { Mail, Lock, User, GraduationCap, BookOpen, Sparkles } from 'lucide-react'
...
export default function RegisterPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const success = register(formData.name, formData.email, formData.password, formData.userType)
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold text-medad-ink dark:text-dark-text">
                مداد<span className="text-primary-600 dark:text-primary-400">.</span>
              </h1>
            </div>
            <h2 className="text-2xl font-bold text-medad-ink dark:text-dark-text mb-2">
              إنشاء حساب جديد
            </h2>
            <p className="text-gray-600 dark:text-dark-muted">انضم إلى مجتمع الأبحاث الأكاديمية</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              ...
              <span className="text-sm text-gray-600 dark:text-dark-muted">
                أوافق على{' '}
                <Link href="/terms" className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300">
                  الشروط والأحكام
                </Link>{' '}
                و{' '}
                <Link href="/privacy" className="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300">
                  سياسة الخصوصية
                </Link>
              </span>
            </div>
